...
public class GenericUserController implements IController, CanLoginController {
    ...
    @Override
    public SingletonRepository<List<IUser>, IUser, IUser> getGenericUserRepository() {
        return userRepository;
    }

    @Override
    public SingletonRepository<Set<Pair<IUser, List<StatusInfo<UserStatus>>>>, Pair<IUser, List<StatusInfo<UserStatus>>>, IUser> getUserStatusRepository() {
